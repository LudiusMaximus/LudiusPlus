...
L["Spellbook Icon Position"] = "Posición del icono en el libro de hechizos"
L["Choose the corner where the overlay icon appears on spellbook buttons."] = "Elige la esquina donde aparece el icono de superposición en los botones del libro de hechizos."
...
L["Action Bar Icon Position"] = "Posición del icono en la barra de acción"
L["Choose the corner where the overlay icon appears on action bar buttons."] = "Elige la esquina donde aparece el icono de superposición en los botones de la barra de acción."
