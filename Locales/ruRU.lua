...
L["Druids only: Use Travel Form or Flight Form as \"mounting\", and Humanoid form as \"dismounting\", instead of standard mounts."] = "Только друиды: Использовать Походный облик или Облик птицы как «транспорт» и гуманоидный облик как «спешивание»."
L["Dracthyr Soar instead of mounting"] = "Драктир Парение вместо транспорта"
L["Dracthyr only: Use Soar as \"mounting\" and humanoid form as \"dismounting\", instead of standard mounts."] = "Только драктиры: Использовать Парение как «транспорт» и гуманоидный облик как «спешивание»."
