...
L["Down with %s!"] = "%s — на дно!"
L["Make the \"%1$s\" category (i.e., the %2$s shop) the last entry in the category list of the House Editor's %3$s frame, so it is no longer the default category upon opening."] = "Сделать категорию «%1$s» (т. е. магазин %2$s) последней в списке категорий окна %3$s редактора дома, чтобы она больше не была категорией по умолчанию при открытии."
...
L["Not working in the \"%1$s\" category. The \"Technically Advanced Editor\" (TAE) wants no part of %2$s!"] = "Недоступно в категории «%1$s»."
