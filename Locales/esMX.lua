...
L["Dracthyr Soar instead of mounting"] = "Dracthyr Elevarse en lugar de montura"
L["Dracthyr only: Use Soar as \"mounting\" and humanoid form as \"dismounting\", instead of standard mounts."] = "Solo Dracthyr: Usa Elevarse como «montar» y forma humanoide como «desmontar», en lugar de monturas estándar."
...
L["Spell Icon Overlay"] = "Superposición de ícono de hechizo"
L["Display an |A:UI-RefreshButton:16:16:0:0|a icon overlay on spells in the spellbook or action bars that are included in the single-button combat rotation. So you can identify them at a glance."] = "Muestra una superposición de ícono |A:UI-RefreshButton:16:16:0:0|a en los hechizos del libro de hechizos o barras de acción que están incluidos en la rotación de combate de un solo botón. Para que puedas identificarlos de un vistazo."
L["Show in Spellbook"] = "Mostrar en el libro de hechizos"
L["Display the |A:UI-RefreshButton:16:16:0:0|a icon overlay on spells in your spellbook that are included in the single-button combat rotation."] = "Muestra la superposición de ícono |A:UI-RefreshButton:16:16:0:0|a en los hechizos de tu libro de hechizos que están incluidos en la rotación de combate de un solo botón."
L["Spellbook Icon Position"] = "Posición del ícono en el libro de hechizos"
L["Choose the corner where the overlay icon appears on spellbook buttons."] = "Elige la esquina donde aparece el ícono de superposición en los botones del libro de hechizos."
L["Show on Action Bars"] = "Mostrar en barras de acción"
L["Display the |A:UI-RefreshButton:16:16:0:0|a icon overlay on action bar buttons for spells included in the rotation."] = "Muestra la superposición de ícono |A:UI-RefreshButton:16:16:0:0|a en los botones de la barra de acción para los hechizos incluidos en la rotación."
L["Action Bar Icon Position"] = "Posición del ícono en la barra de acción"
L["Choose the corner where the overlay icon appears on action bar buttons."] = "Elige la esquina donde aparece el ícono de superposición en los botones de la barra de acción."
L["Only when Single-Button is used"] = "Solo cuando se usa un solo botón"
L["Only show the |A:UI-RefreshButton:16:16:0:0|a icon overlay on action bars if the Single-Button Assistant spell is currently placed on an action bar."] = "Solo muestra la superposición de ícono |A:UI-RefreshButton:16:16:0:0|a en las barras de acción si el hechizo Asistente de un solo botón está colocado actualmente en una barra de acción."
...
L["Not being able to properly inspect the decor items in the small icons of the House Editor's %s and %s frames is a s#!tshow obviously. Ludius Plus's \"Technically Advanced Editor\" (TAE) - among other things - adds a slider to change the decor icon size and a preview side-pane (opened with CTRL + LEFT CLICK). This way, TAE gives you a better knowledge of what decor items look like before you place them. And knowledge is power!"] = "Los iconos de vista previa de los objetos de decoración en las ventanas %s y %s del editor de casas pueden ser demasiado pequeños para verse con claridad. El editor de casas mejorado de Ludius Plus añade, entre otras cosas, un control deslizante para cambiar el tamaño de los iconos y un panel lateral de vista previa (se abre con CTRL - CLIC IZQUIERDO)."
L["Icon size slider"] = "Control deslizante de tamaño de icono"
L["When enabled, a slider is added to the House Editor's %s/%s frame to customize the size of the decor icons."] = "Si está activado, se añade un control deslizante a la ventana %s/%s del editor de casas para personalizar el tamaño de los iconos de decoración."
L["Decor preview for %s/%s frame"] = "Vista previa de decoración para la ventana %s/%s"
L["When enabled, you can CTRL + LEFTCLICK on decor icons in the House Editor's %s/%s frame to open a model preview next to it."] = "Si está activado, puedes hacer CTRL + CLIC IZQUIERDO en los iconos de decoración de la ventana %s/%s del editor de casas para abrir una vista previa del modelo al lado."
...
L["Not working in the \"Featured\" category. The \"Technically Advanced Editor\" (TAE) wants no part of %s"] = "¡No funciona en conjunto con %s!"
...
L["To use certain features (like Dismount Toggle and Flashlight), LudiusPlus needs your permission to run macros.\n\nPlease click \"Allow Scripts\" below, then \"Yes\" in the game's confirmation pop-up to enable these modules."] = "Para usar ciertas funciones (como Alternar Montar/Desmontar y Linterna), LudiusPlus necesita tu permiso para ejecutar macros.\n\nPor favor, haz clic en \"Permitir Scripts\" abajo, y luego en \"Sí\" en la confirmación del juego para habilitar estos módulos."
