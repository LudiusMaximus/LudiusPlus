...
L["Skip Dragon Isles Supplies purchases"] = "Omitir compras con Suministros de las Islas Dragón"
L["Skip Community Coupons purchases"] = "Omitir compras con cupones comunitarios"
...
L["Enhanced House Editor"] = "Editor de casas mejorado"
...
L["Icon resize with slider"] = "Cambiar tamaño de icono con el control deslizante"
...
L["Icon resize with CTRL + mouse wheel"] = "Cambiar tamaño de icono con CTRL + rueda del mouse"
L["When enabled, holding CTRL while scrolling the mouse wheel over the House Editor's %s/%s frame resizes the decor icons."] = "Si está activado, mantener presionado CTRL mientras giras la rueda del mouse sobre la ventana %s/%s del Editor de casas cambia el tamaño de los iconos de decoración."
L["Decor preview"] = "Vista previa de decoración"
...
L["Chain placement when holding SHIFT"] = "Colocación en cadena al mantener presionado MAYÚS"
L["When enabled, holding SHIFT while committing a decor placement immediately starts a new placement of the same item (as long as there are copies left in storage). A small icon at the cursor shows the remaining count."] = "Si está activado, mantener presionado MAYÚS al confirmar la colocación de una decoración inicia inmediatamente una nueva colocación del mismo objeto (siempre que queden copias en el depósito). Un pequeño icono en el cursor muestra la cantidad restante."
...
L["When enabled, a custom \"Recent\" category is added to the House Editor's Storage tab. It lists the decor items you recently modified, newest first - kept separately per house and per indoors/outdoors. Hover a tile and click the red X to drop it from the history. Disabling this option clears the saved history."] = "Si está activado, se añade una categoría personalizada de «Recientes» a la pestaña Almacén del Editor de casas. Enumera los objetos de decoración que has modificado recientemente, los más nuevos primero (se guardan por separado para cada casa y para interiores/exteriores). Pasa el mouse sobre una casilla y haz clic en la X roja para eliminarla del historial. Al desactivar esta opción, se borra el historial guardado."
L["Remove from history"] = "Eliminar del historial"
L["If you cannot resist, go and spend your actual real-life money on it in the %1$s's \"%2$s\" category!"] = "¡Para comprarlo, ve a la categoría «%2$s» del %1$s!"
L["Hide blueprint codes"] = "Ocultar códigos de plano"
L["When enabled, blueprint share codes in the import and export windows are hidden behind dots, with an eye button to reveal them. Handy while streaming or screen-sharing: blueprints can be saved or imported without being exposed to viewers. The Copy and Post-to-Chat buttons work on the real codes regardless."] = "Si está activado, los códigos para compartir planos en las ventanas de importación y exportación se ocultan detrás de puntos, con un botón en forma de ojo para revelarlos. Útil para retransmitir o compartir pantalla: los planos pueden guardarse o importarse sin quedar expuestos a los espectadores. Los botones de Copiar y Publicar en el chat funcionan con los códigos reales de todos modos."
L["Show blueprint code"] = "Mostrar código de plano"
L["Hide blueprint code"] = "Ocultar código de plano"
