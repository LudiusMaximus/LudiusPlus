...
L["Spellbook Icon Position"] = "Zauberbuch-Symbol-Position"
L["Choose the corner where the overlay icon appears on spellbook buttons."] = "Wählt die Ecke, in der das Overlay-Symbol auf Zauberbuch-Buttons erscheint."
...
L["Action Bar Icon Position"] = "Aktionsleisten-Symbol-Position"
L["Choose the corner where the overlay icon appears on action bar buttons."] = "Wählt die Ecke, in der das Overlay-Symbol auf Aktionsleisten-Buttons erscheint."
...
L["Decor preview for %s/%s frame"] = "Dekor-Vorschau fürs %s/%s-Fenster"
...
L["Not working in the \"Featured\" category. The \"Technically Advanced Editor\" (TAE) wants no part of %s"] = "Funktioniert nicht im Zusammenhang mit %s!"
...
L["To use certain features (like Dismount Toggle and Flashlight), LudiusPlus needs your permission to run macros.\n\nPlease click \"Allow Scripts\" below, then \"Yes\" in the game's confirmation pop-up to enable these modules."] = "Um bestimmte Funktionen zu nutzen (wie Ab-/Aufsitzen-Umschalter und Taschenlampe), benötigt LudiusPlus eure Erlaubnis, Makros auszuführen.\n\nBitte klickt unten auf \"Skripte erlauben\" und dann auf \"Ja\" im Bestätigungsfenster des Spiels, um diese Module zu aktivieren."
L["Allow Scripts"] = "Skripte erlauben"
